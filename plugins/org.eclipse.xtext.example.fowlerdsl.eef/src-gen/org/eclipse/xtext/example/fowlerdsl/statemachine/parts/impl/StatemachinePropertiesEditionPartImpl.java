...
public class StatemachinePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, StatemachinePropertiesEditionPart {
		...
		composer = new PartComposer(statemachine_Step) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == StatemachineViewsRepository.Statemachine_.Properties.resetEvents) {
					return createResetEventsAdvancedReferencesTable(parent);
				}
				if (key == StatemachineViewsRepository.Statemachine_.Properties.commands) {
					return createCommandsAdvancedTableComposition(parent);
				}
	...
	protected Composite createEventsAdvancedTableComposition(Composite parent) {
		this.events = new ReferencesTable(getDescription(StatemachineViewsRepository.Statemachine_.Properties.events, StatemachineMessages.StatemachinePropertiesEditionPart_EventsLabel), new ReferencesTableListener() {
			...
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				events.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				events.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				events.refresh();
			}
		...
		this.events.setHelpText(propertiesEditionComponent.getHelpContent(StatemachineViewsRepository.Statemachine_.Properties.events, StatemachineViewsRepository.SWT_KIND));
		this.events.createControls(parent);
		this.events.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.events, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createResetEventsAdvancedReferencesTable(Composite parent) {
		...
		this.resetEvents.setHelpText(propertiesEditionComponent.getHelpContent(StatemachineViewsRepository.Statemachine_.Properties.resetEvents, StatemachineViewsRepository.SWT_KIND));
		this.resetEvents.createControls(parent);
		this.resetEvents.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.resetEvents, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"resetEvents", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.resetEvents,
	...
	protected void moveResetEvents(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.resetEvents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		resetEvents.refresh();
	}
	...
	protected void removeFromResetEvents(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.resetEvents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		resetEvents.refresh();
	}
	...
	protected Composite createCommandsAdvancedTableComposition(Composite parent) {
		this.commands = new ReferencesTable(getDescription(StatemachineViewsRepository.Statemachine_.Properties.commands, StatemachineMessages.StatemachinePropertiesEditionPart_CommandsLabel), new ReferencesTableListener() {
			...
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.commands, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				commands.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.commands, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				commands.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.commands, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				commands.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.commands.setHelpText(propertiesEditionComponent.getHelpContent(StatemachineViewsRepository.Statemachine_.Properties.commands, StatemachineViewsRepository.SWT_KIND));
		this.commands.createControls(parent);
		this.commands.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.commands, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createCommandsAdvancedTableComposition
	...
	protected Composite createStatesAdvancedTableComposition(Composite parent) {
		this.states = new ReferencesTable(getDescription(StatemachineViewsRepository.Statemachine_.Properties.states, StatemachineMessages.StatemachinePropertiesEditionPart_StatesLabel), new ReferencesTableListener() {
			...
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.states, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				states.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.states, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				states.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.states, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				states.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.states.setHelpText(propertiesEditionComponent.getHelpContent(StatemachineViewsRepository.Statemachine_.Properties.states, StatemachineViewsRepository.SWT_KIND));
		this.states.createControls(parent);
		this.states.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StatemachinePropertiesEditionPartImpl.this, StatemachineViewsRepository.Statemachine_.Properties.states, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	public void initEvents(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(StatemachineViewsRepository.Statemachine_.Properties.events);
		if (eefElementEditorReadOnlyState && events.isEnabled()) {
			events.setEnabled(false);
			events.setToolTipText(StatemachineMessages.Statemachine_ReadOnly);
	...
	public void initResetEvents(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(StatemachineViewsRepository.Statemachine_.Properties.resetEvents);
		if (eefElementEditorReadOnlyState && resetEvents.getTable().isEnabled()) {
			resetEvents.setEnabled(false);
			resetEvents.setToolTipText(StatemachineMessages.Statemachine_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !resetEvents.getTable().isEnabled()) {
			resetEvents.setEnabled(true);
		}
	...
	public void initCommands(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(StatemachineViewsRepository.Statemachine_.Properties.commands);
		if (eefElementEditorReadOnlyState && commands.isEnabled()) {
			commands.setEnabled(false);
			commands.setToolTipText(StatemachineMessages.Statemachine_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !commands.isEnabled()) {
	...
	public void initStates(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(StatemachineViewsRepository.Statemachine_.Properties.states);
		if (eefElementEditorReadOnlyState && states.isEnabled()) {
			states.setEnabled(false);
			states.setToolTipText(StatemachineMessages.Statemachine_ReadOnly);
