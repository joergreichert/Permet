...
public class TransitionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TransitionPropertiesEditionPart {
	...
	protected Composite createEventFlatComboViewer(Composite parent) {
		...
		// Start of user code for createEventFlatComboViewer
	...
	protected Composite createStateFlatComboViewer(Composite parent) {
		...
		// Start of user code for createStateFlatComboViewer
	...
	public void initEvent(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(StatemachineViewsRepository.Transition.Properties.event);
		if (eefElementEditorReadOnlyState && event.isEnabled()) {
			event.setEnabled(false);
			event.setToolTipText(StatemachineMessages.Transition_ReadOnly);
	...
	public void initState(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(StatemachineViewsRepository.Transition.Properties.state);
		if (eefElementEditorReadOnlyState && state.isEnabled()) {
			state.setEnabled(false);
			state.setToolTipText(StatemachineMessages.Transition_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !state.isEnabled()) {
